...
<p align="center">
  ...
  <p align="center">
    <a href="https://codeclimate.com/github/masiya123f/gitprofile/maintainability">
      <img src="https://api.codeclimate.com/v1/badges/c60f42d7d0b61bd33e98/maintainability" />
    </a>
    <a href="https://github.com/masiya123f/gitprofile/actions/workflows/test-deploy.yml">
      <img src="https://github.com/masiya123f/gitprofile/actions/workflows/test-deploy.yml/badge.svg" />
    </a>
    <a href="https://github.com/masiya123f/gitprofile/issues">
      <img src="https://img.shields.io/github/issues/arifszn/gitprofile"/>
    </a>
    <a href="https://github.com/masiya123f/gitprofile/stargazers">
      <img src="https://img.shields.io/github/stars/masiya123f/gitprofile"/>
    </a>
    <a href="https://github.com/masiya123f/gitprofile/network/members">
      <img src="https://img.shields.io/github/forks/arifszn/gitprofile"/>
    </a>
    <a href="https://github.com/masiya123f/gitprofile/commits/main">
      <img src="https://img.shields.io/github/last-commit/arifszn/gitprofile/main"/>
    </a>
    <a href="https://github.com/masiya123f/gitprofile/blob/main/CONTRIBUTING.md">
      <img src="https://img.shields.io/badge/contributions-welcome-brightgreen.svg?style=flat"/>
    </a>
    <a href="https://github.com/masiya123f/gitprofile/blob/main/LICENSE">
      <img src="https://img.shields.io/github/license/masiya123f/gitprofile"/>
    </a>
  ...
  <p align="center">
    <a href="https://masiya123f.github.io/gitprofile">View Demo</a>
    ·
    <a href="https://github.com/masiya123f/gitprofile/issues">Report Bug</a>
    ·
...
<p align="center">
  <a href="https://masiya123f.github.io/gitprofile">
    <img src="https://github.com/arifszn/gitprofile/assets/45073703/eb6c38a4-ac92-4006-869b-e4e24f6f5cf6" alt="Preview" width="60%"/>
  </a>
  <br/>
  <a href="masiya123f"><img src="https://github.com/masiya123f/gitprofile/assets/45073703/4d2ccd45-e566-4743-bf61-cadc03ece54c" width="50%" alt="Shadow"/></a>
</p>
...
To view a live example, **[click here](https://masiya123f.github.io/gitprofile)**.

<p align="center">
  <img src="https://github.com/masiya123f/gitprofile/assets/45073703/406e8368-415a-42ef-89c5-d43cc8bbeb19" alt="Themes">
</p>
...
- **Fork repo:** Click [here](https://github.com/masiya123f/gitprofile/fork) to fork the repo so you have your own project to customize. A "fork" is a copy of a repository.
- **Rename repo:**
...
- **Enable workflows:** Go to your repo's **Actions** tab and enable workflows.
  ...
  ![Workflows](https://github.com/masiya123f/gitprofile/assets/45073703/7e82f7d4-900c-4cb9-83f9-bcaa1ca2b910)
...
- **Commit the changes:** Now commit to your **main** branch with your changes. Wait a few minutes so that the CI/CD pipeline can publish your website to GitHub Pages. You can check the progress in the [Actions](https://github.com/masiya123f/gitprofile/actions) tab.
...
[**Not working?**](https://github.com/masiya123f/gitprofile/discussions/548)
...
- Clone the project and change directory.
  ...
  ```shell
  git clone https://github.com/masiya123f/gitprofile.git
  cd gitprofile
  ```
...
> Alternatively, you can set up and run the project using Docker with **[Vail](https://github.com/masiya123f/vail)**, a powerful tool for local development of JavaScript/TypeScript Apps.
...
const CONFIG = {
  github: {
    username: 'masiya123f', // Your GitHub org/user name. (This is the only required config)
  },
  /**
   * If you are deploying to https://<USERNAME>.github.io/, for example your repository is at https://github.com/masiya123f/masiya123f.github.io, set base to '/'.
   * If you are deploying to https://<USERNAME>.github.io/<REPO_NAME>/,
   * for example your repository is at https://github.com/masiya123f/portfolio, then set base to '/portfolio/'.
   */
  base: '/gitprofile/',
  projects: {
    github: {
      ...
      automatic: {
        ...
        exclude: {
          ...
          projects: [], // These projects will not be displayed. example: ['masiya123f/my-project1', 'masiya123f/my-project2']
        },
      },
      manual: {
        // Properties for manually specifying projects
        projects: ['masiya123f/gitprofile', 'masiya123f/pandora'], // List of repository names to display. example: ['masiya123f/my-project1', 'arifszn/my-project2']
      },
    },
    external: {
      header: 'My Projects',
  ...
  social: {
    linkedin: 'siyabonga khumalo',
    twitter: 'siyabonga khumalo',
    mastodon: 'siyabonga@mastodon.social',
    researchGate: '',
    facebook: '',
    instagram: '',
    reddit: '',
    ...
    skype: '',
    telegram: '',
    website: 'https://www.masiya123f.com',
    phone: '',
  ...
  footer: `Made with <a 
      class="text-primary" href="https://github.com/masiya123f/gitprofile"
      target="_blank"
      rel="noreferrer"
    >GitProfile</a> and ❤️`,
...
<p align="center">
  <img src="https://github.com/masiya123f/gitprofile/assets/45073703/91a2d9e6-67e5-47b4-9752-1881ac0f907f" alt="Theme Dropdown" width="50%">
</p>
...
**GitProfile** supports [hotjar](https://www.hotjar.com) to track visitor interaction and behavior. If you do not want to use, keep the `id` empty.
...
![PWA](https://github.com/masiya123f/gitprofile/assets/45073703/9dc7cc5c-4262-4445-a7a5-1e3566ef43fa)
...
![Blog](https://github.com/masiya123f/gitprofile/assets/45073703/410124f2-a3c2-48f1-8ec8-0c6fae74ae3d)

The posts are fetched by [blog.js](https://github.com/masiya123f/blog.js).

## 💖 Support

<p>You can show your support by starring this project. ★</p>
<a href="https://github.com/masiya123f/gitprofile/stargazers">
  <img src="https://img.shields.io/github/stars/masiya123f/gitprofile?style=social" alt="Github Star">
</a>
